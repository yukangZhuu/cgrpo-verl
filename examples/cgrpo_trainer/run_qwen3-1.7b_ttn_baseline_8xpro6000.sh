#!/bin/bash
# TTN Baseline: Standard GRPO on teacher_traces_new 3k
...
export VERL_FILE_LOGGER_PATH=logs/ttn_baseline_8xpro6000_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn_baseline_3k_8xpro6000' \
    trainer.default_local_dir=checkpoints/ttn_baseline_3k \
    ...
    trainer.debug_dump_dir=debug_samples/ttn_baseline \
