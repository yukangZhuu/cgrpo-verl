#!/bin/bash
# Monotone Frontier Curriculum (MFC) on TTN unsolvable 100+28 anchors.
# guidance_mode=hint, curriculum_method=mfc
# Hardware: 8x RTX PRO 6000 (96GB)
# Matched 1:1 with run_ttn2k_unsolvable_adaptive_hint_8xpro6000.sh for a
# clean AdaBack vs. MFC comparison.
set -x
