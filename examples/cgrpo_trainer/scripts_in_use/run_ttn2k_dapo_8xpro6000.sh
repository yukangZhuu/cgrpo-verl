#!/bin/bash
# Config A: DAPO Recipe — Baseline GRPO on TTN-2K with DAPO-style stabilization
...
export VERL_FILE_LOGGER_PATH=logs/ttn2k_dapo_8xpro6000_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn2k_dapo_8xpro6000' \
    trainer.default_local_dir=checkpoints/ttn2k_dapo \
    ...
    trainer.debug_dump_dir=debug_samples/ttn2k_dapo \
