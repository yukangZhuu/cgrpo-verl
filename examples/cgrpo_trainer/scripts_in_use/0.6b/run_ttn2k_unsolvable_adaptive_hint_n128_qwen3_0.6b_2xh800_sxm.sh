...
# with Qwen3-0.6B as base, 2x H800 SXM5 80GB.
#
# Direct port of run_ttn2k_unsolvable_adaptive_hint_n128_qwen3_0.6b_8xrtx5090.sh,
...
# min_step_delta and all KL/clip/lr) are byte-identical to the 1.7B
# AdaBack launchers and the 0.6B 5090 AdaBack launcher, so cross-base-size
# AND cross-hardware comparison is direct.
#
...
export VERL_FILE_LOGGER_PATH=logs/ttn2k_unsolvable_adaptive_hint_n128_qwen3_0.6b_2xh800_sxm_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn2k_unsolvable_adaptive_hint_n128_qwen3_0.6b_2xh800_sxm' \
    trainer.default_local_dir=checkpoints/ttn2k_unsolvable_adaptive_hint_n128_qwen3_0.6b_2xh800_sxm \
    ...
    trainer.debug_dump_dir=debug_samples/ttn2k_unsolvable_adaptive_hint_n128_qwen3_0.6b_2xh800_sxm \
