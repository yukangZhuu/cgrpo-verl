...
# Qwen3-0.6B as base, 2x H800 SXM5 80GB.
#
# Direct port of run_ttn2k_unsolvable_mfc_v2_hint_qwen3_0.6b_8xrtx5090.sh,
...
#
# Algorithm hyperparameters (mfc_curriculum.variant / tau / default_rho_max
# and all KL/clip/lr) are byte-identical to the 1.7B MFC v2 launcher and
# the 0.6B 5090 MFC v2 launcher, so cross-base-size AND cross-hardware
...
export VERL_FILE_LOGGER_PATH=logs/ttn2k_unsolvable_mfc_v2_hint_qwen3_0.6b_2xh800_sxm_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn2k_unsolvable_mfc_v2_hint_qwen3_0.6b_2xh800_sxm' \
    trainer.default_local_dir=checkpoints/ttn2k_unsolvable_mfc_v2_hint_qwen3_0.6b_2xh800_sxm \
    ...
    trainer.debug_dump_dir=debug_samples/ttn2k_unsolvable_mfc_v2_hint_qwen3_0.6b_2xh800_sxm \
