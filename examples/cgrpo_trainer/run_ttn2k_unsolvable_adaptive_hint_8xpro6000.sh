#!/bin/bash
# Per-sample adaptive curriculum (AdaBack-style) on TTN unsolvable 100+28 anchors
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn2k_unsolvable_adaptive_hint_8xpro6000' \
    trainer.default_local_dir=checkpoints/ttn2k_unsolvable_adaptive_hint \
    ...
    trainer.debug_dump_dir=debug_samples/ttn2k_unsolvable_adaptive_hint \
