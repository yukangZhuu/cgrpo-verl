...
export VERL_FILE_LOGGER_PATH=logs/ttn2k_baseline_8x5090_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    actor_rollout_ref.rollout.gpu_memory_utilization=0.58 \
    ...
    trainer.experiment_name='ttn2k_baseline_8x5090' \
