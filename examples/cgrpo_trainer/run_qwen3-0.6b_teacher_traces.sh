...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='verl_cgrpo_qwen3_0.6b_teacher_traces_2.25_1' \
    trainer.default_local_dir=checkpoints/verl_cgrpo_qwen3_0.6b_teacher_traces_2.25_1 \
