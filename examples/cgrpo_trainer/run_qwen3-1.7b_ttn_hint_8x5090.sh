...
export VERL_FILE_LOGGER_PATH=logs/ttn_hint_metrics.jsonl
mkdir -p logs
...
python3 -m verl.trainer.main_cgrpo \
    ...
    trainer.experiment_name='ttn_hint_8x5090' \
    trainer.default_local_dir=checkpoints/ttn_hint \
    ...
    trainer.debug_dump_dir=debug_samples/ttn_hint \
